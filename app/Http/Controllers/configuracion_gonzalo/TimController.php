...
class TimController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('configuracion_gonzalo/vw_tasa_interes_moratorio', compact('menu','permisos'));
    }
    ...
    public function getTim(Request $request){
        ...
        $totalg = DB::select("select count(id_tim) as total from fraccionamiento.vw_tim");
        $page = $_GET['page'];
        $limit = $_GET['rows'];
        $sidx = $_GET['sidx'];
        $sord = $_GET['sord'];
        ...
        $sql = DB::table('fraccionamiento.vw_tim')->orderBy($sidx, $sord)->limit($limit)->offset($start)->get();
