                    ...
                    <div class="panel-group smart-accordion-default" id="accordion-2" style="padding-right: 11px;">
                        ...
                        <div class="panel panel-default" style="background:  transparent;">
                            <div class="panel-heading" style="background: #2471A3; color: white">
                                ...
                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseOne-1"> <i class="fa fa-fw fa-plus-circle txt-color-white"></i> <i class="fa fa-fw fa-minus-circle txt-color-white"></i> Programas Sociales </a></h4>
                            </div>
                                           ...
                                           <div class="widget-body">
                                               <div class="tree smart-form" style="color:white !important">
                                                ...
                                                <div class="panel-heading" style=" background:  transparent;color: white;">
                                                    <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-3" class="collapsed" href="programas_sociales"> 
