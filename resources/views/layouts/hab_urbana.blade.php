                    ...
                    <div class="panel-group smart-accordion-default" id="accordion-2" style="padding-right: 11px;">
                        ...
                        <div class="panel panel-default" style="background:  transparent;">
                            <div class="panel-heading" style="background: #2471A3; color: white">
                                ...
                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseOne-1"> <i class="fa fa-fw fa-plus-circle txt-color-white"></i> <i class="fa fa-fw fa-minus-circle txt-color-white"></i> Habilitación Urbana  </a></h4>
                            </div>
