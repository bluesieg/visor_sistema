                    ...
                    <ul id="tabs1" class="nav nav-tabs bordered">
                        <li class="active">
                            <a href="#s1" data-toggle="tab" aria-expanded="true">
                                Mantenimiento de Licencias de Funcionamiento
                        ...
                        <div id="s1" class="tab-pane fade active in">
                            <div class="col-xs-12" style="padding: 5px">
                                ...
                                <div  class="col-xs-12 text-right" style=" padding-top: 5px">
                                        <button  type="button" class="btn btn-labeled bg-color-blue txt-color-white" onclick="nuevo_lic_fun(0);">
    ...
    $.ajax({url: 'gethab_urb_by_id/'+id,
        ...
        map.on('singleclick', function(evt) {
            ...
            var fl = map.forEachFeatureAtPixel(evt.pixel, function (feature, layer) {
                ...
                if(layer.get('title')=='Lic. Fun.'&&mostrar==0)
                {
                    mostrar=1;
                    $("#hidden_lic_fun").val(feature.get('id_lote'));
                    nuevo_lic_fun(feature.get('id_lote'));
                    return false;
                }
            });
    ...
    <div class='cr_content col-xs-12 ' style="margin-bottom: 10px;">
        <div class="col-xs-12 cr-body" >
            ...
            <section class="col-xs-12" style="padding: 0px">
                ...
                <div class="col-xs-3" style="padding-left: 0px;">
                    <button style="width: 100%" type="button" class="btn btn-labeled bg-color-greenLight txt-color-white" onclick="map_reg_lote_lic_fun();">
            ...
            <div class="col-xs-12" style="padding-left: 0px; margin-top: 5px ">
                <div class="input-group input-group-md" style="width: 100%">
                    ...
                    <div class="icon-addon addon-md">
                        ...
                        <input class=" form-control" style="height: 32px; width: 100%" id="dlg_edit_ruc_lic_fun" type="text" maxlength="12" onkeypress="return soloDNI(event);" >
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12" style="padding-left: 0px; margin-top: 5px">
                <div class="input-group input-group-md" style="width: 100%">
                    ...
                    <div class="icon-addon addon-md">
                        <input class=" form-control" style="height: 32px; width: 100%" id="dlg_edit_empresa_lic_fun" type="text" >
                    </div>
                </div>
            </div>
            <div class="col-xs-12" style="padding-left: 0px; margin-top: 5px">
                <div class="input-group input-group-md" style="width: 100%">
                    ...
                    <div class="icon-addon addon-md">
                        <input class=" form-control" style="height: 32px; width: 100%" id="dlg_edit_ubicacion_lic_fun" type="text" >
                    </div>
                </div>
            </div>
            <div class="col-xs-12" style="padding-left: 0px; margin-top: 5px">
                <div class="input-group input-group-md" style="width: 100%">
                    ...
                    <div class="icon-addon addon-md">
                        <input class=" form-control" style="height: 32px; width: 100%" id="dlg_edit_representante_lic_fun" type="text" >
                    </div>
                </div>
            </div>
            <div class="col-xs-6" style="padding-left: 0px; margin-top: 5px">
                <div class="input-group input-group-md" style="width: 100%">
                    ...
                    <div class="icon-addon addon-md">
                        <select class=" form-control" style="height: 32px; width: 100%" id="dlg_edit_tip_emp_lic_fun" >
            ...
            <div class="col-xs-6" style="padding-left: 0px; margin-top: 5px">
                <div class="input-group input-group-md" style="width: 100%">
                    ...
                    <div class="icon-addon addon-md">
                        <input class=" form-control" style="height: 32px; width: 100%" id="dlg_edit_cnt_tra_lic_fun" type="text" onkeypress="return soloDNI(event);" >
                    </div>
                </div>
            </div>
            <div class="col-xs-12" style="padding-left: 0px; margin-top: 5px">
                <div class="input-group input-group-md" style="width: 100%">
                    ...
                    <div class="icon-addon addon-md">
                        <select class=" form-control" style="height: 32px; width: 100%" id="dlg_edit_uso_lic_fun">
                            @foreach($usos as $usos)
                            <option value="{{$usos->id_uso}}">{{$usos->uso}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                        ...
                        <li  >
                            <span style="width: 170px;">
                                <label class="checkbox inline-block" >
                                    <input type="checkbox" name="checkbox-inline" id="chk_lic_fun"/>
                                    <i></i>
                                   Licencia Aprobada
                                </labe>
                            </span>
            ...
            <div  class="col-xs-12 text-right" style=" padding-top: 5px">
                    <button id="save_button"  type="button" class="btn btn-labeled bg-color-green txt-color-white" onclick="save_lic_fun(1);">
                        <span class="btn-label"><i class="glyphicon glyphicon-save"></i></span>Grabar
                    </button>
                    <button id="scan_button"  type="button" class="btn btn-labeled bg-color-blue txt-color-white" onclick="subir_scan_lic_fun();">
                        <span class="btn-label"><i class="glyphicon glyphicon-save"></i></span>Subir Scaneo
                    </button>
                    <button id="mod_button"  type="button" class="btn btn-labeled bg-color-blue txt-color-white" onclick="save_lic_fun(2);">
...
<div id="dlg_view_foto_lic_fun" style="display: none;">
    <div class="col-xs-12">
       <div class=" col-xs-3">
            <div class="input-group input-group-md">
                <input type="hidden" id="dlg_idpre" value="0">
    ...
    <div class="panel panel-success cr-panel-sep" style="border:0px; margin-top: 10px">
        <div class="panel-body cr-body">
            <div id="dlg_img_view_big_lic_fun" style="padding-top: 0px"></div>
        </div>
    </div>
</div> 
            ...
            <form id="FormularioScans" name="FormularioScans" method="post" enctype="multipart/form-data" action="callpdf"  target="ifrafile">
                ...
                <div class="col-xs-12" style="padding: 0px; padding-top: 10px ">
                    <div class="input-group input-group-md" style="width: 100%">
                        ...
                        <div>
                            <input name="dlg_documento_file" id="dlg_documento_file" type="file"  class="form-control" style="height: 32px; width: 100%" onchange="llamarsubmitscan_lic_fun();">
                        </div>
                    </div>
                </div>
                <div class="col-xs-12" style="padding: 0px; padding-top: 10px ">
