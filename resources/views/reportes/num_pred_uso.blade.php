...
<main>
    ...
    <center><div Class="asunto" style="margin-top: 10px;"><b>REPORTE NÚMERO DE PREDIOS DE LA EMISION PREDIAL POR USOS</b></div></center>
    ...
    <div class="lado3" style="height: 435px; border-bottom: 1px solid #333">
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 0px; font-size: 1.3em;">
            ...
            <tr >
                ...
                <th style="width: 50%;">USO PREDIO</th>
                <th style="width: 20%">N° PREDIOS</th>
            </tr>
            </thead>
            <tbody>
            ...
            @foreach ($sql as $cont)
                <tr>
                    ...
                    <td style="text-align: center;">{{ $cont->sector }}</td>
                    <td style="text-align: center;">{{ $cont->uso_arbitrio }}</td>
                    <td style="text-align: center;">{{$cont->num_predios}}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
