        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="text-center error-box">
                    ...
                    <br />
                    <p class="lead">
                        No se pudo encontrar la página que solicitó, póngase en contacto con su webmaster o vuelva a intentarlo. Utilice el botón <b>Atras</b> de su navegador para navegar a la página de la que proviene.
                    </p>
                    <p class="font-md">
