        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="text-center error-box">
                    <h1 class="error-text-2 bounceInDown animated"> Error de Falta de Permisos <span class="particle particle--c"></span><span class="particle particle--a"></span><span class="particle particle--b"></span></h1>
                    <h2 class="font-xl"><strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i> Usted <u>No</u> Tiene Permisos para entrar</strong></h2>
                    <br />
                    <p class="lead">
                        Póngase en contacto con su webmaster para que le brinde los permisos necesarios o vuelva a intentarlo. Utilice el botón <b>Atras</b> de su navegador para navegar a la página de la que proviene.
                    </p>
                    <p class="font-md">
                        <b>... Eso no te ha funcionado?</b>
                    </p>
                    <br>
                    <div class="error-search well well-lg padding-10">
                        <div class="input-group">
                            <input class="form-control input-lg" type="text" placeholder="Escribe y busca" id="search-error">
