...
<body>
    <main>
        ...
        <center><div Class="asunto" style="margin-top: 0px;"><b>REPORTE OBRA - GDUC</b></div></center>
        ...
        <table style="margin-top: 5px; margin-bottom: 5px !important;">
            <tr>
                <td colspan="2" style="border:0px;">
                    <b>III. <span style=" text-decoration: underline">INFORMACION DE OBRA</span></b>
                </td>
            </tr>
        </table>
        ...
        <table style="margin-top: 10px; margin-bottom: 5px !important; border-bottom: 1px solid black">
            ...
            <tr>
                <td style="border:0px; padding-left:18px; width: 35%">
                    <b> EXPEDIENTE TECNICO</b>
                </td>
                @if($sql[0]->expediente_tecnico == '1')
                    <td style="border:0px;">
                        : SI
                    </td>
                @else
