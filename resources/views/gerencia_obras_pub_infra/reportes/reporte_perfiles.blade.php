...
<body>
    <main>
        ...
        <center><div Class="asunto" style="margin-top: 0px;"><b>REPORTE PEFIL - GDUC</b></div></center>
        ...
        <table style="margin-top: 5px; margin-bottom: 5px !important;">
            <tr>
                <td colspan="2" style="border:0px;">
                    <b>III. <span style=" text-decoration: underline">INFORMACION DE PERFIL</span></b>
                </td>
            </tr>
        </table>
        ...
        <table style="margin-top: 10px; margin-bottom: 5px !important; border-bottom: 1px solid black">
            ...
            <tr>
                <td style="border:0px; padding-left:18px; width: 35%">
                    <b> RESPONSABILIDAD FUNCIONAL</b>
                </td>
                <td style="border:0px;">
                    : {{$sql[0]->responsabilidad_func}}
                </td>
            </tr>
            <tr>
                <td style="border:0px; padding-left:18px; width: 35%">
            ...
            <tr>
                <td style="border:0px; padding-left:18px; width: 35%">
                    <b> NUMERO BENEFICIARIOS</b>
                </td>
                <td style="border:0px;">
                    : {{$sql[0]->num_beneficiarios}}
                </td>
            </tr>
            <tr>
                <td style="border:0px; padding-left:18px; width: 35%">
                    <b> CANTIDAD ALTERNATIVAS</b>
                </td>
                <td style="border:0px;">
                    : {{$sql[0]->cantidad}}
                </td>
