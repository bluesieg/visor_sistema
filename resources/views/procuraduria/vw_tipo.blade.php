                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <section style="padding-right: 0px">
                                        ...
                                        <div class="row" style="padding: 0px; margin-top: 30px">
                                            ...
                                            <div class="col-xs-2">
                                                <div class="text-left">
                                                        <button type="button" class="btn btn-labeled bg-color-greenLight txt-color-white" onclick="fn_buscar_tipos();">
                                           ...
                                           <div class="col-xs-5">
                                                ...
                                                <button type="button" class="btn btn-labeled bg-color-greenLight txt-color-white" onclick="crear_nuevo_tipo();">
                                                    <span class="btn-label"><i class="glyphicon glyphicon-plus-sign"></i></span>Nuevo Tipo
                                                </button>

                                                <button  type="button" class="btn btn-labeled bg-color-blue txt-color-white" onclick="modificar_tipo();">
                                            ...
                                            <div class="col-xs-12" style="padding: 0px; margin-top: 30px">
                                                <article class="col-xs-12" style=" padding: 0px !important">
                                                        <table id="table_tipos"></table>
                                                        <div id="pager_table_tipos"></div>
                                                </article>
                                            </div>
...
<script type="text/javascript">
    $(document).ready(function (){
        ...
        jQuery("#table_tipos").jqGrid({
            ...
            pager: '#pager_table_tipos',
            rowList: [50, 100],
            gridComplete: function () {
                    var idarray = jQuery('#table_tipos').jqGrid('getDataIDs');
                    if (idarray.length > 0) {
                    var firstid = jQuery('#table_tipos').jqGrid('getDataIDs')[0];
                            $("#table_tipos").setSelection(firstid);    
                        }
                },
            onSelectRow: function (Id){},
            ondblClickRow: function (Id){modificar_tipo();}
        });
...
@stop
<script language="JavaScript" type="text/javascript" src="{{ asset('archivos_js/procuraduria/tipo.js') }}"></script>
