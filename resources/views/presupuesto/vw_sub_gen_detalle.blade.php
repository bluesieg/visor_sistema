                            ...
                            <div class="col-xs-12">
                                <div class="text-right">                                    
                                    ...
                                    @if( $permisos[0]->btn_new ==1 )
                                        <button onclick="dlg_subgen_detalle();" type="button" class="btn btn-labeled bg-color-greenLight txt-color-white">
                                    ...
                                    @if( $permisos[0]->btn_edit ==1 )
                                        <button onclick="up_dlg_subgen_detalle();" type="button" class="btn btn-labeled bg-color-blue txt-color-white">
                                    ...
                                    @if( $permisos[0]->btn_del ==1 )
                                        <button onclick="del_subgen_detalle();" type="button" class="btn btn-labeled btn-danger">
