                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <section style="padding-right: 0px">
                                        ...
                                        <div class="row" style="padding: 0px; margin-top: 30px">
                                            ...
                                            <div class="col-xs-2">
                                                <div class="text-left">
                                                        <button type="button" class="btn btn-labeled bg-color-greenLight txt-color-white" onclick="buscar_proceso();">
                                           ...
                                           <div class="col-xs-5 text-right">
                                                ...
                                                <button type="button" class="btn btn-labeled bg-color-greenLight txt-color-white" onclick="new_proceso();">
                                                    <span class="btn-label"><i class="glyphicon glyphicon-plus-sign"></i></span>Nuevo
                                                </button>

                                                <button  type="button" class="btn btn-labeled bg-color-blue txt-color-white" onclick="edit_proceso();">
                                            ...
                                            <div class="col-xs-12" style="padding: 0px; margin-top: 30px">
                                                <article class="col-xs-12" style=" padding: 0px !important">
                                                        <table id="table_asesoria_proceso"></table>
                                                        <div id="pager_table_asesoria_proceso"></div>
                                                </article>
                                            </div>
...
<script type="text/javascript">
    $(document).ready(function (){
        ...
        jQuery("#table_asesoria_proceso").jqGrid({
            url: 'asesoria_legal/0?grid=proceso',
            ...
            pager: '#pager_table_asesoria_proceso',
            rowList: [50, 100],
            gridComplete: function () {
                    var idarray = jQuery('#table_asesoria_proceso').jqGrid('getDataIDs');
                    if (idarray.length > 0) {
                    var firstid = jQuery('#table_asesoria_proceso').jqGrid('getDataIDs')[0];
                            $("#table_asesoria_proceso").setSelection(firstid);    
                        }
                },
            onSelectRow: function (Id){},
            ondblClickRow: function (Id){edit_proceso();}
        });
...
@stop
<script language="JavaScript" type="text/javascript" src="{{ asset('archivos_js/asesoria_legal/asesoria_proceso.js') }}"></script>
