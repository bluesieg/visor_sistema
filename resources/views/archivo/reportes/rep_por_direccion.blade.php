...
<html lang="en">
  ...
  <body>
    <main>
        ...
        <center><div Class="asunto" style="margin-top: 0px;"><b>LISTA DE CONTRIBUYENTES POR DIRECCION</b></div></center>
        <input type="hidden" value=" {{$num=1}}">
        <table border="0" cellspacing="0" cellpadding="0" style=" margin-top: 10px" >
        <thead>
          <tr>
              <th style="width: 20%">Direccion Buscada</th>
              <td style="text-align: left;font-size: 0.7em; padding-left: 5px;">{{strtoupper($dir)}}</td>
          </tr>
        </thead>
        ...
        <thead>
          <tr>
              ...
              <th style="width: 20%">Domicilio Fiscal</th>
              <th style="width: 6%">N° Expe</th>
              <th style="width: 15%">Ultimo Documento</th>
              <th style="width: 28%">Direcciones Registradas</th>
          </tr>
        </thead>
        <tbody>
